...
#SBATCH --array=5 #1-412 #5,60,171,189 #421 #1043
...
#Rscript /gpfs52/home/zhoud2/script/common_rare/common/step3_common_magma.r

Rscript /home/zhoud2/script/common_rare/common/maf05/step3_common_magma.r  ${SLURM_ARRAY_TASK_ID}
